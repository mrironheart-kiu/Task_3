...
public class ConstantUrl {
    public static final String URL_HOME_PAGE = "https://stellarburgers.education-services.ru";
    public static final String URL_REGISTER_PAGE = String.format("%s/register", URL_HOME_PAGE);
    public static final String URL_LOGIN_PAGE = String.format("%s/login", URL_HOME_PAGE);
    public static final String URL_ACCOUNT_PAGE = String.format("%s/account", URL_HOME_PAGE);
    public static final String URL_PROFILE_PAGE = String.format("%s/profile", URL_ACCOUNT_PAGE);
    public static final String URL_FORGOT_PASSWORD_PAGE = String.format("%s/forgot-password", URL_HOME_PAGE);
